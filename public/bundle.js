...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CreateVotePageBtn = __webpack_require__(222);

	var _CreateVotePageBtn2 = _interopRequireDefault(_CreateVotePageBtn);

	var _CreateVotePage = __webpack_require__(223);

	var _CreateVotePage2 = _interopRequireDefault(_CreateVotePage);
	...
	var App = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(_reactRouter.Route, { path: '/', component: _CreateVotePageBtn2.default }),
				_react2.default.createElement(_reactRouter.Route, { path: 'CreateVotePage', component: _CreateVotePage2.default })
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CreateVotePageBtn = _react2.default.createClass({
		displayName: 'CreateVotePageBtn',
		...
		render: function render() {
			return _react2.default.createElement(
				'a',
				{ href: 'javascript:;', className: 'CreateVotePageBtn', onClick: this.onClick },
				'发起投票'
			);
		}
	});

	exports.default = CreateVotePageBtn;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _YoungCard = __webpack_require__(224);

	var _YoungCard2 = _interopRequireDefault(_YoungCard);

	var _ShareBtn = __webpack_require__(225);
	...
	var CreateVotePage = _react2.default.createClass({
		displayName: 'CreateVotePage',
		...
		render: function render() {
			...
			for (var i = 0; i < this.state.cardNumber; i++) {
				cardNodes.push(_react2.default.createElement(_YoungCard2.default, null));
			}
			return _react2.default.createElement(
				'div',
				{ className: 'createVotePage' },
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'btn' },
						_react2.default.createElement(_AddVoteBtn2.default, { addVote: this.addVote })
					)
				),
	...
	exports.default = CreateVotePage;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddOption = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				'a',
				{ href: 'javascript:;', className: 'addOption btn-primary', onClick: this.props.handleClick },
				'添加选项'
			);
		}
	});
	...
	// 完成按钮
	var FinishBtn = _react2.default.createClass({
		displayName: 'FinishBtn',

		render: function render() {
			return _react2.default.createElement(
				'a',
				{ href: 'javascript:;', className: 'finish btn-primary', onClick: this.props.handleClick },
				'完成'
			);
		}
	});
	...
	//增加投票项按钮
	var AddVoteBtn = _react2.default.createClass({
		displayName: 'AddVoteBtn',

		render: function render() {
			return _react2.default.createElement(
				'a',
				{ href: 'javascript:;', className: 'addVoteBtn btn-primary' },
				'增加投票项'
			);
		}
	});
	...
	var YoungCard = _react2.default.createClass({
		displayName: 'YoungCard',
		...
		optionDescriptionChange: function optionDescriptionChange(e) {
			var i = parseInt(e.target.getAttribute('placeholder').slice(2), 10);
			...
			if (this.state.finish) {
				...
				for (var i = 0; i < this.state.total; i++) {
					optionNodes.push(_react2.default.createElement(
						'option',
						{ value: this.state.optionValueArr[i] },
						this.state.optionValueArr[i]
					));
				}
				return _react2.default.createElement(
					'div',
				...
				var _optionNodes = [];
				for (var _i = 0; _i < this.state.total; _i++) {
					var placeholderStr = '选项' + _i;
					_optionNodes.push(_react2.default.createElement(OptionDescription, { serialNumber: _i, placeholder: placeholderStr, handleChange: this.optionDescriptionChange }));
				}
				return _react2.default.createElement(
					'div',
					{ className: 'youngCard' },
					...
					_react2.default.createElement(
						AddOption,
						{ handleClick: this.addOption },
						'添加选项'
					),
					_react2.default.createElement(
						FinishBtn,
						{ handleClick: this.finish },
						'完成'
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ShareBtn = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				'a',
				{ href: 'javascript:;', className: 'share', onClick: this.shareToWeChat },
				'分享到微信'
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AddVoteBtn = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				'a',
				{ href: 'javascript:;', className: 'btn-primary addVoteBtn', onClick: this.props.addVote },
				'增加投票项'
			);
		}
	});
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'theme' },
					_react2.default.createElement('textarea', { placeholder: '输入投票主题，2-80字' })
				)
			);
		}
	});
	...
	var Footer = _react2.default.createClass({
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'forSharpCorner' },
					_react2.default.createElement('div', { id: 'shareToWeChatBox' }),
					_react2.default.createElement('em', { className: 'a' }),
					_react2.default.createElement('em', { className: 'b' })
				),
				_react2.default.createElement(_ShareBtn2.default, null)
			);
		}
	});
